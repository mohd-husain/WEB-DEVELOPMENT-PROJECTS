        ...
        <header>
            <div className='border-b-1 border-[#ccc] py-2'>
                <div className='max-w-[1320px] text-[14px] mx-auto flex justify-between'>
                    <div>Contact us 24/7 : +91-9874561233 furnitureinfo@gmail.com</div>
                    <div>
                        ...
                        <div id="mega-menu-icons" className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                            <ul className="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                                ...
                                <li>
                                    ...
                                    <div id="mega-menu-icons-dropdown" className="absolute z-10  hidden w-auto grid-cols-2 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 md:grid-cols-3 dark:bg-gray-700">
